...
- **Número de WhatsApp/teléfono actualizado** de `+57 300 000 0000` (placeholder) a `+57 300 225 8378` (real), en `js/whatsapp.js` (`CONFIG.phone`) y en los 5 enlaces `wa.me`/`tel:` del HTML (navbar, hero, footer — llamada y WhatsApp, botón flotante).
